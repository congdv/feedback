...
export default function FeedbackCreateForm({
  ...
  const [selectedTag, setTag] = useState<string | undefined>(
    post?.tagId ?? undefined
  );
  const [selectedStatus, setStatus] = useState<string | undefined>(
    post?.statusId ?? undefined
  );
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <div className="flex justify-between">
          <div>
            <Select
              onValueChange={handleOnTagChange}
